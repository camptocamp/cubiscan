...
def test_parse_neg_measure_response():
    scanner_obj = CubiScan('127.0.0.1', '1234')
...
def test_parse_no_core_response():
    scanner_obj = CubiScan('127.0.0.1', '1234')
...
def test_parse_no_core_response_neg():
    scanner_obj = CubiScan('127.0.0.1', '1234')
...
def test_parse_dim_calibration():
    scanner_obj = CubiScan('127.0.0.1', '1234')
...
def test_parse_weight_calibration():
    scanner_obj = CubiScan('127.0.0.1', '1234')
